...
class DataGenerator(object):
		def __init__(self, total_read_light=2):
				...
				self.scenario_by_sensor = dict({
						...
						'uv': {'normal': {'less_or_equal': 0.5}, 'risk': {'greater': 1.3}},
						'gas': None,
						'humidity_temperature':	{'risk': {'summer': {'11': {'temp': [19, 22], 'hum': [68, 71]},
																												 '12': {'temp': [19, 22], 'hum': [67, 72]},
																												 '13': {'temp': [23, 27], 'hum': [63, 66]},
																												 '14': {'temp': [23, 27], 'hum': [57, 61]},
																												 '15': {'temp': [28, 33], 'hum': [55, 59]},
																												 '16': {'temp': [28, 33], 'hum': [50, 54]},
																												 '17': {'temp': [29, 33], 'hum': [45, 49]},
																												 '18': {'temp': [33, 37], 'hum': [39, 44]},
																												 '19': {'temp': [33, 38], 'hum': [38, 43]},
																												 '20': {'temp': [34, 38], 'hum': [37, 42]},
																												 '21': {'temp': [34, 38], 'hum': [36, 39]},
																		 ...
																		 'normal': {'summer': {'11': {'temp': [18, 21], 'hum': [70, 72]},
																													 '12': {'temp': [19, 22], 'hum': [69, 70]},
																													 '13': {'temp': [21, 23], 'hum': [68, 70]},
																													 '14': {'temp': [22, 24], 'hum': [63, 66]},
																													 '15': {'temp': [25, 27], 'hum': [59, 62]},
																													 '16': {'temp': [26, 29], 'hum': [57, 61]},
																													 '17': {'temp': [27, 30], 'hum': [54, 56]},
																													 '18': {'temp': [28, 30], 'hum': [52, 54]},
																													 '19': {'temp': [29, 30], 'hum': [50, 52]},
																													 '20': {'temp': [29, 30], 'hum': [50, 52]},
																													 '21': {'temp': [28, 30], 'hum': [50, 51]},
